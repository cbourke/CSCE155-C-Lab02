...
\begin{enumerate}
  \item Go to your \mintinline{text}{labs} directory and clone the Lab 2.0 project
  ...
  \mintinline{text}{worksheet.md} file)
...
\begin{enumerate}
  \item Hand in your completed \mintinline{text}{dollar.c} and 
  \mintinline{text}{area.c} source files as well as your completed
  \mintinline{text}{worksheet.md} file through the webhandin
...
Modify the \mintinline{text}{birthday_cli} program to
